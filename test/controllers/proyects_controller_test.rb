...
class ProyectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proyect" do
    assert_difference('Proyect.count') do
      post proyects_url, params: { proyect: { description: @proyect.description, name: @proyect.name } }
    end
  ...
  test "should update proyect" do
    patch proyect_url(@proyect), params: { proyect: { description: @proyect.description, name: @proyect.name } }
